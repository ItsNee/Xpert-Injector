...
1:      Me.Show()
    ...
    Private Sub MonoFlat_Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click

    End Sub

    Private Sub MonoFlat_Label1_Click(sender As Object, e As EventArgs) Handles Label1.Click
